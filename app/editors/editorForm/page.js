...
const Form = () => {
    return (
        ...
        <section class="max-w-4xl p-6 mx-auto bg-white  rounded-md shadow-md dark:bg-gray-800   -translate-y-36">
...
<form>
    <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
        ...
        <div>
            <label class="text-gray-700 dark:text-gray-200" for="passwordConfirmation">Additional Description</label>
            <textarea placeholder='type here' class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"/>
        </div>
        <div>
            <label class="text-gray-700 dark:text-gray-200" for="password">Attach File</label>
            <input type='file' placeholder='type here' class="block w-full px-4 py-2 mt-2 border-2 border-dashed text-gray-700 bg-white  border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"/>
        </div>

    </div>

    <div class="flex justify-end mt-6">
        <button class="px-8 py-2.5 leading-5  w-full text-white transition-colors duration-300 transform bg-[#334A55] rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">Send</button>
    </div>
</form>
</section>
    </div>
